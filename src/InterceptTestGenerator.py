		...
		if(randSim):
			...
			for count in range(0,numSteps):
				...
				if(human):
					...
					ax.contourf(z,y,c,cmap = 'viridis'); 
					plt.pause(0.5); 
...
if __name__ == "__main__":
	'''
	Solver Notes:
	Rewards are currently based on being within half a meter, while observations are capable out to a meter
	...
	alsave = '../policies/interceptAlphas6.npy'; 
	alLoad = '../policies/interceptAlphas5.npy'; 
